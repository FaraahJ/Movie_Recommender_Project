...
2. Two models that were saved using Pickle, model.pkl and similarity.pkl.
...
1. The new dataset used for this system that can be found [here](https://www.kaggle.com/datasets/debanganghosh/imdb-dataset?resource=download) 
...
3. The KNNWithMeans algorithm showed the best RMSE score, and was therefore saved as a model with Pickle.
